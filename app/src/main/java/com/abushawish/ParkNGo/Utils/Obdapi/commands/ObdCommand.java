package com.abushawish.ParkNGo.Utils.Obdapi.commands;


import com.abushawish.ParkNGo.Utils.Obdapi.exceptions.BusInitException;
import com.abushawish.ParkNGo.Utils.Obdapi.exceptions.MisunderstoodCommandException;
import com.abushawish.ParkNGo.Utils.Obdapi.exceptions.NoDataException;
import com.abushawish.ParkNGo.Utils.Obdapi.exceptions.NonNumericResponseException;
import com.abushawish.ParkNGo.Utils.Obdapi.exceptions.ResponseException;
import com.abushawish.ParkNGo.Utils.Obdapi.exceptions.StoppedException;
import com.abushawish.ParkNGo.Utils.Obdapi.exceptions.UnableToConnectException;
import com.abushawish.ParkNGo.Utils.Obdapi.exceptions.UnknownErrorException;
import com.abushawish.ParkNGo.Utils.Obdapi.exceptions.UnsupportedCommandException;
...
public abstract class ObdCommand {
    ...
    protected void fillBuffer() {
        ...
        buffer.clear();
        System.out.println("rawData before = " + rawData);
        rawData = rawData.substring(rawData.indexOf("4") + 1);
        if (rawData.charAt(0) != '4') {
            rawData = "4" + rawData;
        }
